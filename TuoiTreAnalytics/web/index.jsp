...
<html>
    <head>
        ...
        <title>TuoiTreAnalysis - Thành Viên Nhóm</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">
                                Trang Tổng Quan <small>Thống kê cơ sở dữ liệu</small>
                            </h1>
                            <ol class="breadcrumb">
                                <li class="active">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="alert alert-info alert-dismissable">
                                ...
                                <i class="fa fa-info-circle"></i>  <strong>Dữ liệu được thống kê ở thời điểm hiện tại</strong>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
